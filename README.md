...
We highlight 6 non-trivial demo tasks in this codebase (see details below).

These components can be used either individually, or orchestrated by 
`evojax.trainer` and `evojax.sim_mgr` that manage the training pipeline. 
...
As a quickstart, we provide examples (scripts in `examples/` and notebooks in `examples/notebooks`) to illustrate the usage of EvoJAX.  
...
* [Abstract](https://github.com/google/evojax/blob/main/examples/notebooks/AbstractPainting01.ipynb)
[Painting](https://github.com/google/evojax/blob/main/examples/notebooks/AbstractPainting02.ipynb) -
